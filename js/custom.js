$(function(){
    ...
    //frame header
    //create webchat header
    var iframe_chat = '<iframe class="wc-webchat" id="wc-webchat-main" style="display: none" src="' + efo_server + '/efo?refresh_log_flg=1&force_log_flg=1&connect_page_id=5a38f794059408963e1ce55d"></iframe>';
